...
"""
    OrderedDict - отображение, в котором ключи хранятся так же как и задавались. Гарантируя фиксированную последовательность.
"""
...
"""
    ChainMap - хранение нескольких словарей в одном инстансе для одновременного доступа ко всем из них, через объект, как к одному.
"""
...
"""
    Counter - отображение, в котором с каждым ключом ассоциирован счетчик. Принемает итерируемый объект.
"""
